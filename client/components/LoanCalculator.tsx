        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="flex justify-between text-xs text-gray-500 mt-1">
              ...
              <span className="font-semibold text-primary">{duration} mesi</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-primary">Calcolatore Prestito</h3>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex justify-between text-sm text-gray-500 mt-2">
                <span>€5.000</span>
                <span className="font-semibold text-primary text-lg">{formatCurrency(amount)}</span>
                <span>€{useManualInput ? '500.000' : '100.000'}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex justify-between text-sm text-gray-500 mt-2">
                ...
                <span className="font-semibold text-primary text-lg">{duration} mesi</span>
            ...
            <div className="mt-4">
              ...
              >
                {useManualInput ? '← Torna ai cursori' : '✏️ Inserimento manuale'}
              </button>
            </div>
        ...
        {/* Results Section */}
        <div>
          <h4 className="text-xl font-bold text-primary mb-6">Risultati del Calcolo</h4>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-6 rounded-xl">
              ...
              <div className="text-3xl font-bold text-primary">{formatCurrency(monthlyPayment)}</div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-600">Totale da rimborsare</span>
                </div>
                <div className="text-xl font-bold text-secondary">{formatCurrency(totalAmount)}</div>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <TrendingUp className="h-5 w-5 text-secondary mr-2" />
                  <span className="text-sm font-medium text-gray-600">Interessi totali</span>
                </div>
                <div className="text-xl font-bold text-secondary">{formatCurrency(totalInterest)}</div>
              </div>
            </div>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Importo richiesto: <strong>{formatCurrency(amount)}</strong></li>
                <li>• Durata: <strong>{duration} mesi</strong></li>
                <li>• Tasso fisso: <strong>2% annuo</strong></li>
                <li>• Rata mensile: <strong>{formatCurrency(monthlyPayment)}</strong></li>
              </ul>
            </div>
          </div>
        </div>
