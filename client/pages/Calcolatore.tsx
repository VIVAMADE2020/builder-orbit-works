  ...
  const benefits = [
    {
      ...
      description: 'Algoritmo avanzato che calcola la rata esatta considerando tutti i parametri del prestito.'
    },
    {
      icon: <TrendingUp className="h-12 w-12 text-secondary" />,
      title: 'Tasso Fisso 2%',
      description: 'Tasso competitivo e fisso per tutta la durata del prestito, senza sorprese.'
    },
    {
      icon: <Shield className="h-12 w-12 text-secondary" />,
      title: 'Nessuna Commissione',
      description: 'Zero commissioni nascoste. Il calcolo include solo gli interessi al 2% annuo.'
    },
    {
      icon: <Clock className="h-12 w-12 text-secondary" />,
      title: 'Flessibilità',
      description: 'Durata da 1 a 240 mesi per adattarsi perfettamente alle tue possibilità.'
    }
  ];
  ...
  const examples = [
    {
      ...
      totalAmount: 10531.80,
      totalInterest: 531.80
    },
    {
      amount: 25000,
      duration: 60,
      monthlyPayment: 438.71,
      totalAmount: 26322.60,
    ...
    },
    {
      ...
      totalAmount: 56364.00,
      totalInterest: 6364.00
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Calcola subito la tua rata mensile con il nostro strumento preciso e affidabile. 
            Scopri quanto puoi risparmiare con i nostri tassi competitivi.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-2xl font-bold text-primary mb-6">Perché Scegliere Noi</h3>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary mb-4">Esempi di Calcolo</h2>
            <p className="text-lg text-gray-600">
              Alcuni esempi pratici per aiutarti a capire come funziona il nostro calcolatore
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Il nostro calcolatore utilizza la formula matematica standard per il calcolo 
                  dei prestiti, considerando un tasso fisso del 2% annuo su tutti i nostri prodotti.
                </p>
                <p>
                  <strong>Formula utilizzata:</strong> Il calcolo si basa sulla formula dell'ammortamento 
                  francese, che distribuisce equamente capitale e interessi su tutte le rate.
                </p>
                <p>
                  <strong>Precisione garantita:</strong> I calcoli sono accurati al centesimo e 
                  corrispondono esattamente a quelli che troverete nel contratto finale.
                </p>
              </div>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-primary mb-4">Parametri del Prestito</h3>
