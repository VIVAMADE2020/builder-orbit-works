  ...
  return (
    <div className="min-h-screen bg-white py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-5xl font-bold text-primary mb-6">Mutuo Immobiliare</h1>
        <p className="text-xl text-gray-600 mb-8">
          Questa pagina è in fase di sviluppo. Contattaci per maggiori informazioni sui mutui immobiliari.
        </p>
