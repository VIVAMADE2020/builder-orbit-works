...
const RichiestaPrestito: React.FC = () => {
  ...
  const loanTypes = [
    ...
    { id: 'consolidamento', label: 'Consolidamento Debiti', icon: <Euro className="h-6 w-6" />, color: 'bg-indigo-500' }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-primary mb-6">Informazioni Personali</h2>
            ...
            {/* Loan Information */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-6">Dettagli del Prestito</h2>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {loanTypes.map((type) => (
                    ...
                    >
                      <div className={`w-10 h-10 ${type.color} rounded-lg flex items-center justify-center text-white mb-3`}>
                        {type.icon}
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-bold text-secondary">
                        €{Math.round(calculateEstimatedPayment()).toLocaleString()}
                      </div>
                    </div>
                  </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-primary mb-6">Situazione Finanziaria</h2>
