  ...
  const loanTypes = [
    {
      ...
      description:
        "Finanziamenti personalizzati per le tue esigenze quotidiane",
      image:
    ...
    },
    {
      ...
      description:
        "Realizza il sogno della casa con i nostri mutui vantaggiosi",
      image:
    ...
    },
    {
      title: "Prestito Auto",
      description:
        "Finanzia il tuo veicolo dei sogni con condizioni vantaggiose",
      image:
        "https://images.pexels.com/photos/7144259/pexels-photo-7144259.jpeg",
      path: "/prestito-auto",
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Servizio eccellente! Ho ottenuto il prestito in tempi record. Consigliato!",
      avatar: "🇮🇹",
    },
    {
      name: "Anna Schmidt",
      ...
      rating: 5,
      text: "Professionalità e competenza. Ottimo supporto durante tutto il processo.",
      avatar: "🇩🇪",
    },
    {
      name: "Lucia Bianchi",
      ...
      rating: 5,
      text: "Finalmente una società seria che mantiene le promesse. Grazie!",
      avatar: "🇮🇹",
    },
    {
      name: "Hans Müller",
      ...
      rating: 4,
      text: "Processo veloce e trasparente. Molto soddisfatto del servizio ricevuto.",
      avatar: "🇩🇪",
    },
    {
      name: "Jana Novakova",
      location: "Bratislava, Slovacchia",
      rating: 5,
      text: "Personale gentile e disponibile. Prestito approvato in 24 ore!",
      avatar: "🇸🇰",
    },
    {
      name: "Giuseppe Verde",
      ...
      rating: 5,
      text: "Tassi davvero competitivi. Consiglio a tutti!",
      avatar: "🇮🇹",
    },
    {
      name: "Sofia Weber",
      ...
      rating: 5,
      text: "Esperienza fantastica dall'inizio alla fine. Altamente raccomandato.",
      avatar: "🇩🇪",
    },
    {
      name: "Peter Novak",
      location: "Kosice, Slovacchia",
      rating: 4,
      text: "Servizio clienti eccezionale. Hanno risolto ogni mio dubbio.",
      avatar: "🇸🇰",
    },
    {
      ...
      rating: 5,
      text: "Rapidità e professionalità. Non potevo chiedere di meglio!",
      avatar: "🇮🇹",
    },
    {
      name: "Thomas Klein",
      location: "Colonia, Germania",
      rating: 5,
      text: "Processo digitale semplice e sicuro. Molto soddisfatto!",
      avatar: "🇩🇪",
    },
  ];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center group">
                ...
                <p className="text-secondary font-semibold mb-2 text-sm md:text-base">
                  {member.role}
                </p>
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Il nostro processo di approvazione richiede generalmente 24 ore
                lavorative. Per prestiti istantanei, la risposta arriva in soli
                15 minuti.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Applichiamo un tasso fisso del 2% annuo per tutti i tipi di
                prestito, senza commissioni nascoste.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Sì, è possibile estinguere o ridurre il prestito in qualsiasi
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Documento d'identità, ultime buste paga o dichiarazione redditi,
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Richiedi subito il tuo prestito personalizzato. Processo veloce,
