...
const PrestitoAuto: React.FC = () => {
  ...
  const vehicleTypes = [
    ...
    },
    {
      ...
      examples: ['Iveco Daily', 'Ford Transit', 'Mercedes Sprinter', 'Fiat Ducato'],
      maxAmount: '€100.000',
      maxDuration: '84 mesi'
    }
  ];
  ...
  const steps = [
    {
      step: '1',
      title: 'Scegli l\'Auto',
      description: 'Trova il veicolo che desideri presso qualsiasi concessionario'
    },
    {
      step: '2',
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Realizza il sogno della tua auto ideale con il nostro prestito auto. 
                Finanziamo auto nuove e usate, moto e veicoli commerciali con le migliori condizioni del mercato.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {vehicleTypes.map((type) => (
            activeVehicle === type.id && (
              <div key={type.id} className="bg-white rounded-2xl shadow-xl p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="mb-6">
                      <h4 className="font-semibold text-primary mb-3">Esempi di veicoli finanziabili:</h4>
                  ...
                  <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-6 rounded-xl">
                    <h4 className="font-bold text-primary mb-4">Condizioni di finanziamento:</h4>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Importo massimo:</span>
                        <span className="font-bold text-primary">{type.maxAmount}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Durata massima:</span>
                        <span className="font-bold text-primary">{type.maxDuration}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Tasso fisso:</span>
                        <span className="font-bold text-secondary">2% annuo</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Anticipo:</span>
                        <span className="font-bold text-secondary">Non richiesto</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {advantages.map((advantage, index) => (
              <div key={index} className="bg-gray-50 p-6 rounded-xl">
                <div className="flex items-center mb-4">
                  {advantage.icon}
                  <h3 className="font-bold text-primary ml-3">{advantage.title}</h3>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Requisiti semplici e alla portata di tutti per ottenere il finanziamento
              </p>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl">
                ...
                <p className="text-gray-700">
                  Porta con te il preventivo dell'auto che desideri acquistare per velocizzare 
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Non aspettare oltre! Richiedi subito il tuo prestito auto e guida il veicolo 
            dei tuoi sogni in pochi giorni.
          </p>
