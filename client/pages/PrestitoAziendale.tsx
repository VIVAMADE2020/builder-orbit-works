  ...
  const benefits = [
    {
      ...
      description: 'Investi nella crescita della tua azienda con capitale di lavoro immediato'
    },
    {
      icon: <Clock className="h-12 w-12 text-secondary" />,
      title: 'Liquidità Rapida',
      description: 'Ottieni liquidità velocemente per cogliere le opportunità di mercato'
    },
    {
      icon: <Shield className="h-12 w-12 text-secondary" />,
      title: 'Flessibilità',
      description: 'Piani di rimborso personalizzati in base al tuo ciclo di cassa'
    },
    {
  ...
  const useCases = [
    {
      ...
      title: 'Espansione',
      description: 'Apertura nuove sedi, assunzione personale, ampliamento locali'
    },
    {
      icon: <PieChart className="h-8 w-8 text-secondary" />,
      title: 'Capitale di Giro',
      description: 'Gestione flussi di cassa, pagamento fornitori, scorte magazzino'
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Finanzia la crescita della tua azienda con i nostri prestiti aziendali su misura. 
                Capitale di lavoro, investimenti, espansioni: realizziamo insieme i tuoi progetti imprenditoriali.
              </p>
            ...
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-center mb-4">
                  {useCase.icon}
                  <h3 className="text-lg font-bold text-primary ml-3">{useCase.title}</h3>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Requisiti semplici e chiari per accedere al nostro prestito aziendale
              </p>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl">
                <h4 className="font-bold text-primary mb-2">💡 Consiglio dell'Esperto</h4>
                <p className="text-gray-700">
                  Prepara tutta la documentazione in anticipo per velocizzare il processo di approvazione. 
                  Il nostro team ti assisterà nella preparazione dei documenti necessari.
                </p>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Aziende che hanno realizzato i loro progetti con il nostro supporto
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h4 className="text-xl font-bold text-primary mb-3">Manifattura Italiana SRL</h4>
              <p className="text-gray-600 mb-4">
                "Grazie al prestito di €150.000 abbiamo acquistato nuovi macchinari e aumentato la produzione del 40%."
              </p>
              <div className="text-sm text-secondary font-semibold">Milano, Italia</div>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🛒</div>
              <h4 className="text-xl font-bold text-primary mb-3">TechShop GmbH</h4>
              <p className="text-gray-600 mb-4">
                "Con €80.000 abbiamo aperto 3 nuovi punti vendita e raddoppiato il fatturato in 18 mesi."
              </p>
              <div className="text-sm text-secondary font-semibold">Berlino, Germania</div>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🍕</div>
              <h4 className="text-xl font-bold text-primary mb-3">Ristorante Europa</h4>
              <p className="text-gray-600 mb-4">
                "Il prestito di €50.000 ci ha permesso di rinnovare il locale e assumere nuovo personale."
              </p>
              <div className="text-sm text-secondary font-semibold">Bratislava, Slovacchia</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Parlaci del tuo progetto e scopri come possiamo aiutarti a realizzarlo con il nostro prestito aziendale.
          </p>
